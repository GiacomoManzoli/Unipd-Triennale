...
class SolverThread extends Thread{
    ...
    public void run(){
        ...
        while (!pezzi.hasBeenCompleted()){
            PuzzleElement anItem, attachableItem;
            ...
            synchronized (pezzi) {
                if (pezzi.size() < 2) {
                    ...
                    * Il thread quindi si mette in wait sulla lista dei pezzi ad aspettare che un pezzo venga aggiunto */
                    try {
                        //System.out.println(this.getName()+": Mi sospendo");
                        pezzi.wait();
                        ...
                        * il puzzle non sia stato risolto nel mentre e nel caso terminare l'esecuzione del thread*/
                        ...
                        //System.err.println(this.getName()+": Mi hanno ucciso");
                        return;
                    }
                } else {
                    ...
                    //System.out.println(this.getName()+": mi prendo "+anItem.toString());
                }
            } //fine Sync.
