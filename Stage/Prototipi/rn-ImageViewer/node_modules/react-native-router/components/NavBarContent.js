...
var NavBarContent = React.createClass({
  ...
  render() {
    ...
    /**
     ...
     Ora è possible dichiarare come props della barra di navigazione anche l'angolo sinisto.
     Come priorità è stato scelto:
      Back > route.leftCorner > props.leftCorner
    */
    ...
    if (this.props.route.leftCorner || this.props.leftCorner) {
      var LightCorner = this.props.route.leftCorner || this.props.leftCorner;
      leftCornerContent = <LightCorner toRoute={this.goForward} customAction={this.customAction} />;
    }
