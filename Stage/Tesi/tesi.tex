...
\input{capitoli/capitolo-2} %Analisi dei framework 
\input{capitoli/capitolo-3} %Strumenti e tecnlogie utilizzati
\input{capitoli/capitolo-4} %Analisi dei requisiti
\input{capitoli/capitolo-5} %Progettazione
\input{capitoli/capitolo-6} %Realizzazione
